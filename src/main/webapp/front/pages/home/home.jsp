		...
		<div id="app">
			...
			<div class="recommend-container">
				...
				<div class="line-container">
					<p class="line"> 旅游景点推荐 </p>
				</div>
				<div class="recommend-list">
					<ul class="recommend-item">
						<li v-for="(item,index) in lvyoujingdianRecommend" v-bind:key="index" @click="jump('../lvyoujingdian/detail.jsp?id='+item.id)">
						
                                                                                                                                                                                                    
                            <img :src="item.jingdiantupian?item.jingdiantupian.split(',')[0]:''" width="218" height="218">
                            
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        
							                                                        
                            <a class="img" href="#" :title="item.jingdianmingcheng"></a>
                            <a class="wor" href="#" :title="item.jingdianmingcheng">{{item.jingdianmingcheng}}</a>
			...
			<div class="data-container layui-row">
				...
				<div style="text-align: center;margin-top: 20px;">
					<button @click="jump('../lvyouxianlu/list.jsp')" type="button" class="layui-btn layui-btn-primary">查看更多>></button>
				</div>
				<div class="data-list layui-col-md8 layui-col-md-offset2">
					<div @click="jump('../lvyouxianlu/detail.jsp?id='+item.id)" class="data-item layui-col-md3"  v-for="(item,index) in lvyouxianluList" v-bind:key="index" v-if="item">
																																																						
						<img class="cover" :src="item.xianlutupian?item.xianlutupian.split(',')[0]:''">
				...
				http.request('news/list', 'get', {
					...
					if (newsList.length > 2 && newsList.length <= 8) {
						...
						console.log('rightNewsList',rightNewsList,vue.rightNewsList)
                                                                                                                ...
                                                                                                                // 获取推荐信息
				http.request(`lvyoujingdian/autoSort?limit=4`, 'get', {
					page: 1,
					limit: 4
				}, function(res) {
					vue.lvyoujingdianRecommend = res.data.list
				});
                                                                                                                                                                                                                
				
                
                                                                                                                                                http.request(`lvyouxianlu/list?limit=4`, 'get', {
					page: 1,
					limit: 4
				}, function(res) {
					vue.lvyouxianluList = res.data.list
				});
