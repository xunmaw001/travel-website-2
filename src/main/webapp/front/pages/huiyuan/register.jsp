		...
		<div class="login-container">
			...
			<form class="layui-form login-form">
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="huiyuanhao" name="huiyuanhao" placeholder="请输入会员号" autocomplete="off" class="layui-input">
					</div>
				</div>
					...
					<div class="layui-input-inline" style="width: 300px;">
						<input type="text" id="huiyuanxingming" name="huiyuanxingming" placeholder="请输入会员姓名" autocomplete="off" class="layui-input">
					</div>
				</div>
                                                                                                                <div class="layui-form-item layui-form-text">
