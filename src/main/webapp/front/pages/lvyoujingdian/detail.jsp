			...
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`lvyoujingdian`);
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					...
					vue.detail = res.data
															vue.title = vue.detail.jingdianmingcheng;
																														// 轮播图片
					vue.swiperList = vue.detail.jingdiantupian ? vue.detail.jingdiantupian.split(",") : [];
																																																																																															var swiperItemHtml = '';
