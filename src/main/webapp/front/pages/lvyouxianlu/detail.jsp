				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div style="word-break:break-all" class="layui-tab-content">
								...
								<div v-html="detail.xianluxiangqing"></div>
							</div>
		...
		<script>
			var vue = new Vue({
				...
				methods: {
					...
					onAcrossTap(acrossTable){
						localStorage.setItem('crossTable',`lvyouxianlu`);
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					// 详情信息
					vue.detail = res.data
															vue.title = vue.detail.xianlumingcheng;
																																								// 轮播图片
					vue.swiperList = vue.detail.xianlutupian ? vue.detail.xianlutupian.split(",") : [];
																																																																											var swiperItemHtml = '';
