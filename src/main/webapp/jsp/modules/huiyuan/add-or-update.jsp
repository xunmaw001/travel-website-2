...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>会员姓名</label>
										<input id="huiyuanxingming" name="huiyuanxingming" class="form-control" placeholder="会员姓名">
									</div>
									<div class="form-group col-md-6">
										<label>性别</label>
	...
	<script>
		...
		function dataBind(){
			...
			$("#huiyuanxingming").val(ruleForm.huiyuanxingming);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.huiyuanxingming != null && res.data.huiyuanxingming != ''){

					$("#huiyuanxingming").val(res.data.huiyuanxingming);
					}
