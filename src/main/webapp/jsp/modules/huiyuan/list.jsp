...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="huiyuanxingmingSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('huiyuanxingming')">会员姓名<i id="huiyuanxingmingIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function search(){
			...
			if($('#huiyuanxingmingSearch').val() != null && $('#huiyuanxingmingSearch').val() != ''){
				searchForm.huiyuanxingming ="%" +  $('#huiyuanxingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("huiyuan/page","GET",{
				...
				huiyuanxingming : searchForm.huiyuanxingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
		...
		function setDataRow(item,number){
			...
			var huiyuanxingmingCell  = document.createElement('td');

						 huiyuanxingmingCell.innerHTML = item.huiyuanxingming;


			row.appendChild(huiyuanxingmingCell);
