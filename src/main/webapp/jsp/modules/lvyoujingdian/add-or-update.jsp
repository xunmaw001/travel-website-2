		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑旅游景点</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑旅游景点</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">旅游景点信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>营业时间</label>
										<div id="yingyeshijianDate" class="input-append date form_datetime">
											<input id="yingyeshijian-input" name="yingyeshijian" size="20" type="text" readonly>
									...
									<div class="form-group col-md-6">
										<label>景点门票</label>
										<input id="jingdianmenpiao" name="jingdianmenpiao" class="form-control" placeholder="景点门票">
									</div>
									<div class="form-group col-md-6">
										<label>注意事项</label>
									...
									<div class="form-group col-md-6">
										<label>景点介绍</label>
										<input id="jingdianjieshao" name="jingdianjieshao" class="form-control" placeholder="景点介绍">
									</div>
	...
	<script>
		...
		var fenleiOptions = [];
				...
				function fenleiSelect(){
					http("option/jingdianfenlei/fenlei","GET",{},(res)=>{
						if(res.code == 0){
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "lvyoujingdian/info/" + id,
		...
		function upload(){
			$('#jingdiantupianupload').fileupload({
				...
				dataType: 'json',
					...
					document.getElementById('jingdiantupian-input').setAttribute('value',baseUrl+"upload/"+data.result.file);
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("lvyoujingdian/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
		...
		function getDetails() {
			...
			if(id != null && id != "" && id != "null"){
				updateId = id;
				window.sessionStorage.removeItem('id');
				http("lvyoujingdian/info/" + id,"GET",{},(res)=>{
					if(res.code == 0){
						ruleForm = res.data
						// 是/否下拉框回显
						setSelectOption();
		...
		function dateTimePick(){
			...
			$("#yingyeshijianDate").datetimepicker({ 
				autoclose: true,
		...
		function dataBind(){
			...
			$("#yingyeshijian-input").val(ruleForm.yingyeshijian);
			$("#jingdianmenpiao").val(ruleForm.jingdianmenpiao);	
		...
		function showImg(){
			...
			$("#jingdiantupianImg").attr("src",ruleForm.jingdiantupian);
		}		
		//跨表
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					$("#jingdiantupianImg").attr("src",res.data.jingdiantupian);
					...
					$("#yingyeshijian-input").val(res.data.yingyeshijian);
					$('#yingyeshijianFileName').val(res.data.yingyeshijian)
					}
					if(res.data != null && res.data != '' && res.data.jingdianmenpiao != null && res.data.jingdianmenpiao != ''){

					$("#jingdianmenpiao").val(res.data.jingdianmenpiao);
					}
