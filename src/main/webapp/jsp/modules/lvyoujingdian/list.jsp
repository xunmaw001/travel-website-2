...
<body>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('jingdianmenpiao')">景点门票<i id="jingdianmenpiaoIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('zhuyishixiang')">注意事项<i id="zhuyishixiangIcon" class="fa fa-sort"></i></th>
											<th onclick="sort('jingdianjieshao')">景点介绍<i id="jingdianjieshaoIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			jingdiantupianImg.setAttribute('src',item.jingdiantupian);
			...
			var jingdianmenpiaoCell  = document.createElement('td');

						 jingdianmenpiaoCell.innerHTML = item.jingdianmenpiao;


			row.appendChild(jingdianmenpiaoCell);
